...
import 'package:toko_merch/controller/barang_controller.dart';
import 'package:toko_merch/models/barang.dart';
...
class _HalamanBarangState extends State<HalamanBarang> {
 Barang_Controller barangController = Barang_Controller();
  final String _temp = "waiting response...";
